...
var (
	...
	// ErrNotRegistered occurs when application was deleted from article and
	// token is not registered in FCM.
	ErrNotRegistered = errors.New("unregistered article")
	...
	// the article.
	ErrDeviceMessageRateExceeded = errors.New("article message rate exceeded")
...
// Unregistered checks if the article token is unregistered,
