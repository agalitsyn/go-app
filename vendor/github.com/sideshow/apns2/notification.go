...
const (
	...
	// into account power considerations for the article. Notifications with this
	...
	// the target article. It is an error to use this priority for a push
...
type Notification struct {
	...
	// A string containing hexadecimal bytes of the article token for the target article.
	DeviceToken string
